...
if 'interface-exception-collector' in services_to_run:
    ...
    print("💊 IEC Health Check: http://localhost:8080/actuator/health")
    print("📈 IEC Metrics: http://localhost:8080/actuator/prometheus")
    print("🐛 IEC Debug Port: localhost:5005")
if 'partner-order-service' in services_to_run:
