...
/**
 * Kafka consumer for OrderCancelled events.
 * Processes incoming order cancellation events and creates interface exceptions.
 */
@Component
...
public class OrderCancelledEventConsumer {
    ...
    /**
     * Consumes OrderCancelled events from Kafka and processes them to create interface exceptions.
    ...
    public void handleOrderCancelledEvent(
        ...
        log.info("Received OrderCancelled event from Kafka - topic: {}, partition: {}, offset: {}, transactionId: {}, externalId: {}",
                topic, partition, offset, transactionId, externalId);

        try {
            // Process the event to create an interface exception
            InterfaceException exception = exceptionProcessingService.processOrderCancelledEvent(event);

            log.info("Successfully processed OrderCancelled event - created exception with ID: {}, transactionId: {}, externalId: {}",
            ...
            log.error("Failed to process OrderCancelled event - transactionId: {}, externalId: {}", 
