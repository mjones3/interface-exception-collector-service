...
public class OrderExceptionConsumer {
     ...
     */
    @KafkaListener(topics = KafkaTopics.ORDER_REJECTED, groupId = "interface-exception-collector", containerFactory = "orderRejectedKafkaListenerContainerFactory")
    ...
    public void handleOrderRejectedEvent(
        ...
        try {
            log.info("=== CONSUMER METHOD CALLED === Received OrderRejected event from partition: {}, offset: {}",
                    partition, offset);
