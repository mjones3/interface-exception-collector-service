...
/**
 * Unit test class for event mapping functionality without Spring context.
 * Verifies that events can be properly mapped to entities and vice versa.
 */
class EventMappingUnitTest {
    ...
    void shouldMapOrderRejectedEventToInterfaceException() {
        ...
        assertThat(exception.getSeverity()).isEqualTo(ExceptionSeverity.LOW);
    }
