...
export const JewelDripicons: IconDefinition = {
    name: 'jewel',
    theme: 'dripicons',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92"><path d="M90.9 31.2L74 13.3c-.8-.8-1.8-1.3-2.9-1.3H20.9c-1.1 0-2.2.5-2.9 1.3l-16.9 18c-1.5 1.6-1.4 4 .1 5.6l42 42c.8.8 1.8 1.2 2.8 1.2s2.1-.4 2.8-1.2l42-42c1.6-1.6 1.6-4.1.1-5.7zM27.4 37l7.4 21.6L13.2 37h14.2zm22-17l6.4 10H36.2l6.4-10h6.8zM46 70.3v-.2L34.8 37h22.4L46 70.1v.2zM64.6 37h14.3L57.2 58.6 64.6 37zm14.6-7H64l-6.4-10h11.7l9.9 10zM22.6 20h11.7L28 30H12.8l9.8-10z"/></svg>'
};
