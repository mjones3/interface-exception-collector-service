...
export const ArrowLeftDripicons: IconDefinition = {
    name: 'arrow-left',
    theme: 'dripicons',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92"><path d="M82 29H45V16c0-1.6-1.2-3.1-2.6-3.7-1.5-.6-3.3-.3-4.4.8l-30.7 30C6.5 43.9 6 44.9 6 46s.4 2.1 1.2 2.9l30.6 30c.8.7 1.8 1.1 2.8 1.1.5 0 1.2-.1 1.7-.3 1.5-.6 2.6-2.1 2.6-3.7V63h37c2.2 0 4-2.3 4-4.5v-25C86 31.3 84.2 29 82 29zm-4 26H40.6c-2.2 0-3.6 1.3-3.6 3.5v8L16.1 46 37 25.5v8c0 2.2 1.4 3.5 3.6 3.5H78v18z"/></svg>'
};
