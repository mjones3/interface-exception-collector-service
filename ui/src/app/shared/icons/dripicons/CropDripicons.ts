...
export const CropDripicons: IconDefinition = {
    name: 'crop',
    theme: 'dripicons',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92"><path d="M88.8 9.8c1.6-1.5 1.6-4.1 0-5.7-1.5-1.6-4.1-1.5-5.7 0L71.2 16H21V8.7c0-2.2-1.8-4-4-4s-4 1.8-4 4V16H6c-2.2 0-4 1.8-4 4s1.8 4 4 4h7v49.9c0 .1.1.2.1.3 0 .2.1.3.1.5 0 .1.1.2.1.4 0 .1.1.3.1.4.1.1.1.2.2.4.1.1.1.2.2.3.1.1.2.3.3.4l.2.2c.2.2.4.3.6.5.1 0 .1.1.2.1l.6.3c.1 0 .2.1.4.1.1 0 .3.1.4.1.3.1.5.1.8.1H69v7c0 2.2 1.8 4 4 4s4-1.8 4-4v-7h7c2.2 0 4-1.8 4-4s-1.8-4-4-4h-7V21.4L88.8 9.8zM63 24L21 64.5V24h42zm6 46H27l42-40.8V70z"/></svg>'
};
