...
export const ListDripicons: IconDefinition = {
    name: 'list',
    theme: 'dripicons',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92"><path d="M91.2 15c0 3.3-2.7 6-6 6H30.1c-3.3 0-6-2.7-6-6s2.7-6 6-6h55.1c3.3 0 6 2.7 6 6zM30.1 52h31.3c3.3 0 6-2.7 6-6s-2.7-6-6-6H30.1c-3.3 0-6 2.7-6 6s2.7 6 6 6zm44.2 19H30.1c-3.3 0-6 2.7-6 6s2.7 6 6 6h44.2c3.3 0 6-2.7 6-6s-2.6-6-6-6zM6.8 8.5c-1.7 0-3.4.7-4.6 1.9s-2 2.9-2 4.6.7 3.4 1.9 4.6c1.2 1.2 2.9 1.9 4.6 1.9s3.4-.7 4.6-1.9c1.2-1.2 1.9-2.9 1.9-4.6s-.7-3.4-1.9-4.6c-1.1-1.2-2.8-1.9-4.5-1.9zm0 31c-1.7 0-3.4.7-4.6 1.9s-2 2.9-2 4.6.7 3.4 1.9 4.6c1.2 1.2 2.9 1.9 4.6 1.9s3.4-.7 4.6-1.9c1.2-1.2 1.9-2.9 1.9-4.6s-.7-3.4-1.9-4.6c-1.1-1.2-2.8-1.9-4.5-1.9zm0 31c-1.7 0-3.4.7-4.6 1.9s-2 2.9-2 4.6.7 3.4 1.9 4.6c1.2 1.2 2.9 1.9 4.6 1.9s3.4-.7 4.6-1.9c1.2-1.2 1.9-2.9 1.9-4.6s-.7-3.4-1.9-4.6c-1.1-1.2-2.8-1.9-4.5-1.9z"/></svg>'
};
