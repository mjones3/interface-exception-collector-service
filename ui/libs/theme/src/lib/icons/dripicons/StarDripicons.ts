...
export const StarDripicons: IconDefinition = {
    name: 'star',
    theme: 'dripicons',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92"><path d="M70.7 88c-.8 0-1.5-.2-2.2-.6L46 72.7 23.5 87.4c-1.4.9-3.2.8-4.5-.1-1.3-1-1.9-2.7-1.5-4.3l7.1-25L3.4 40.1c-1.2-1-1.7-2.7-1.2-4.3s1.9-2.6 3.5-2.8L31 31.2 42.4 6.3C43 4.9 44.4 4 46 4s3 .9 3.6 2.3L61 31.2 86.3 33c1.6.1 3 1.2 3.5 2.8.5 1.5 0 3.2-1.2 4.3L67.5 57.9l7.1 25c.5 1.6-.1 3.3-1.5 4.3-.7.5-1.5.8-2.4.8zM46 64c.8 0 1.5.2 2.2.6L64 74.9l-4.9-17.3c-.4-1.5.1-3.1 1.3-4.1l15.5-13.1L58.1 39c-1.5-.1-2.7-1-3.4-2.3L46 17.6l-8.7 19.1c-.6 1.3-1.9 2.2-3.4 2.3l-17.8 1.3 15.5 13.1c1.2 1 1.7 2.6 1.3 4.1L28 74.9l15.8-10.2c.7-.5 1.4-.7 2.2-.7z"/></svg>'
};
