...
import { TreoMockApiRequestHandler } from './mock-api.request-handler';
...
export class TreoMockApiInterceptor implements HttpInterceptor {
  ...
  intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    const requestHandler: TreoMockApiRequestHandler =
      this._treoMockApiService.requestHandlers[request.method.toLowerCase()].get(request.url);
