package com.arcone.biopro.distribution.partnerorderproviderservice.adapter.in.web.controller.errors;
...
import com.arcone.biopro.distribution.partnerorderproviderservice.infrastructure.config.ApplicationConstants;
 ...
 */
@ControllerAdvice
@Component("bpExceptionTranslator")
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.arcone.biopro");
    }
}
