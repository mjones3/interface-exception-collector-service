...
@SelectDirectories({
        "src/test/java/com/arcone/biopro/distribution/customer/verification/api/features"
})
@ConfigurationParameters({
        @ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.arcone.biopro.distribution.customer.verification"),
