...
import com.arcone.biopro.distribution.recoveredplasmashipping.infrastructure.listener.RecoveredPlasmaCartonUnpackedDomainListener;
...
class RecoveredPlasmaCartonUnpackedDomainListenerTest {

    private RecoveredPlasmaCartonUnpackedDomainListener target;
    private RecoveredPlasmaCartonEventMapper recoveredPlasmaCartonEventMapper;

    private ReactiveKafkaProducerTemplate<String, RecoveredPlasmaCartonUnpackedOutputEvent> producerTemplate;
    ...
    public void setUp(){
        ...
        target = new RecoveredPlasmaCartonUnpackedDomainListener(producerTemplate,"TestTopic", recoveredPlasmaCartonEventMapper,recoveredPlasmaShipmentEntityRepository);
    }
    ...
    public void shouldHandleCartonClosedDomainEvents(){
        ...
        StepVerifier.create(target.handleCartonUnpackedEvent(new RecoveredPlasmaCartonUnpackedEvent(domainPayload)))
            .verifyComplete();
