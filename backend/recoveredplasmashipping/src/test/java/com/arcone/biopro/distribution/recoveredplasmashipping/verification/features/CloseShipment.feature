...
Feature: Close Shipment
    ...
    # This AC should be part of DIS-356
    ...
    Scenario Outline: Successfully closing a shipment with valid ship date
        ...
        When I confirm to cancel the shipment.
        Then I should see a "SUCCESS" message: "Close Shipment has being triggered successfully".
        And The shipment status should be updated to "Processing"
        And The close carton option should be "disabled".
    ...
    Scenario Outline: Successfully closing a shipment
        ...
        Then I should receive a "SUCCESS" message response "Close Shipment has being triggered successfully".
    ...
    Rule: I should not be able to close a shipment with unacceptable products in the shipment.
    @api @DIS-347
    Scenario: Attempting to close shipment with unacceptable products
        Given I have a shipment created with the Customer Code as "408" , Product Type as "RP_FROZEN_WITHIN_120_HOURS", Carton Tare Weight as "1000", Shipment Date as "<tomorrow>", Transportation Reference Number as "DIS-341" and Location Code as "123456789".
        And I have a closed carton with the unit numbers as "W036898786800" and product codes as "E6022V00".
        And The Unacceptable Products Report has flagged unacceptable products in the shipment.
        When I request to close the shipment with ship date as "<tomorrow>"
        Then I should receive a "WARN" message response "Shipment cannot be closed with unacceptable products".
        And The shipment status should be "IN_PROGRESS"
