    ...
    Background:
        ...
        Scenario Outline: Attempt to verify unsuitable products in carton
            ...
            Examples:
                ...
                | 408           | RP_FROZEN_WITHIN_120_HOURS | 1000               | <tomorrow>    | DIS-341                         | 123456789_DIS341 | W036898786701 | W036898786700 | E6022V00     | RP_FROZEN_WITHIN_120_HOURS | WARN       | The verification does not match all products in this order. Please re-scan all the products. | 1                       |
