...
Feature: Print Shipment Summary
    ...
    Background:
        ...
        Scenario: View shipping summary for closed shipment
            ...
            And The print reports option should be "enabled".
            ...
            Then I should see the following information in the shipping summary report:
                ...
                | Ship From Facility Address                       | address_line_1 city, state, 000000 USA                                                                                                 |
                | Ship From Phone                                  | 123-456-7894                                                                                                                           |
                | Shipment Details Transportation Reference Number | Transportation Reference Number: DIS-346                                                                                               |
                | Shipment Details Shipment Number Prefix          | Shipment Number: DIS_346DIS346                                                                                                         |
                | Shipment Closed Date/Time                        | Shipment Date/Time:	05/19/2025 18:31 EDT                                                                                            |
                | Shipment Details Product Type                    | Product Type: RP NONINJECTABLE LIQUID RT                                                                                               |
                | Shipment Details Product Code                    | Product Code: E2534V00, E5880V00, E6022V00                                                                                             |
                | Shipment Details Total Number of Cartons         | Total Number of Cartons: 3                                                                                                             |
                | Shipment Details Total Number of Products        | Total Number of Products: 3                                                                                                            |
                | Testing Statement                                | All products in this shipment meet FDA and ARC-One Solutions testing requirements. These units are acceptable for further manufacture. |
                | Shipment Closing Details Employee Name           | Employee Name: 5db1da0b-6392-45ff-86d0-17265ea33226                                                                                    |
                | Shipment Closing Employee Signature              | Employee Signature:                                                                                                                    |
                | Shipment Closing Details Date                    | Date: <today_formatted>                                                                                                                |
            And I should see the following Carton Information information in the shipping summary report:
                | Carton Number Prefix | Product Code | Product Description        | Total Number of Products |
                | BPMMH1               | E6022V00     | RP NONINJECTABLE LIQUID RT | 1                        |
                | BPMMH1               | E2534V00     | RP NONINJECTABLE FROZEN    | 1                        |
                | BPMMH1               | E5880V00     | RP FROZEN WITHIN 72 HOURS  | 1                        |
