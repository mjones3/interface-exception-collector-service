...
Feature: Print Shipment Summary
    ...
    Background:
        ...
        And I have reset the carton packing slip system configurations following values:
            ...
            | HEADER_SECTION_STATEMENT_TXT | ARC-One Solutions                                                                                                                      | RPS_SHIPPING_SUMMARY_REPORT |
...
#                | Shipment Details	Shipment Date/Time              |                                                                                                                                        |
                ...
                | Shipment Details Product Code                    | E6022V00, E2534V00, E5880V00                                                                                                           |
                ...
                | Carton Information Product Description            | RP NONINJECTABLE LIQUID RT,RP NONINJECTABLE FROZEN,RP NONINJECTABLE LIQUID RT                                                          |
    ...
    Rule: The Transportation Reference Number must be printed only if configured.
        Scenario Outline: Display configured information in the report
            ...
            Examples:
                ...
                | USE_TRANSPORTATION_NUMBER | Y                          | displayTransportationReferenceNumber | Transportation Reference Number | should            | 409           | RP_NONINJECTABLE_LIQUID_RT | 1000               | <tomorrow>    | DIS-346                         | 123456789     | 2                       | W036898786808,W036898786809 | E2488V00, E2488V00 | RP_FROZEN_WITHIN_120_HOURS, RP_FROZEN_WITHIN_120_HOURS |
                | USE_TRANSPORTATION_NUMBER | N                          | displayTransportationReferenceNumber | Transportation Reference Number | should not        | 409           | RP_NONINJECTABLE_LIQUID_RT | 1000               | <tomorrow>    | DIS-346                         | 123456789     | 2                       | W036898786808,W036898786809 | E2488V00, E2488V00 | RP_FROZEN_WITHIN_120_HOURS, RP_FROZEN_WITHIN_120_HOURS |
        ...
        Scenario Outline: Display Header Section configured information in the report
            ...
            Examples:
                | system_configuration_key     | system_configuration_value | element property                     | element                         | should_should_not | Customer Code | Product Type               | Carton Tare Weight | Shipment Date | Transportation Reference Number | Location Code | configured_min_products | unit_number                 | product_code       | product_type                                           |
                | HEADER_SECTION_STATEMENT_TXT | BLA BLA BLA                | displayTransportationReferenceNumber | Transportation Reference Number | should            | 409           | RP_NONINJECTABLE_LIQUID_RT | 1000               | <tomorrow>    | DIS-346                         | 123456789     | 2                       | W036898786808,W036898786809 | E2488V00, E2488V00 | RP_FROZEN_WITHIN_120_HOURS, RP_FROZEN_WITHIN_120_HOURS |
                | HEADER_SECTION_STATEMENT_TXT | ZZZZZZZZ                   | displayTransportationReferenceNumber | Transportation Reference Number | should not        | 409           | RP_NONINJECTABLE_LIQUID_RT | 1000               | <tomorrow>    | DIS-346                         | 123456789     | 2                       | W036898786808,W036898786809 | E2488V00, E2488V00 | RP_FROZEN_WITHIN_120_HOURS, RP_FROZEN_WITHIN_120_HOURS |
