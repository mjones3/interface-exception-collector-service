...
VALUES ('RPS_SHIPPING_SUMMARY_REPORT','TESTING_STATEMENT_TXT','All products in this shipment meet FDA and OneBlood, Inc. testing requirements. These units are acceptable for further manufacture.'),
       ('RPS_SHIPPING_SUMMARY_REPORT','USE_TESTING_STATEMENT','Y'),
       ('RPS_SHIPPING_SUMMARY_REPORT','USE_HEADER_SECTION','Y'),
       ('RPS_SHIPPING_SUMMARY_REPORT','HEADER_SECTION_TXT','OneBlood, Inc.'),
       ...
       ('RPS_SHIPPING_SUMMARY_REPORT','BLOOD_CENTER_NAME','OneBlood, Inc.');
