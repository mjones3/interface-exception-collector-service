...
VALUES ('RPS_SHIPPING_SUMMARY_REPORT','TESTING_STATEMENT_TXT','All products in this shipment meet FDA and ARC-One Solutions testing requirements. These units are acceptable for further manufacture.'),
       ('RPS_SHIPPING_SUMMARY_REPORT','USE_TESTING_STATEMENT','Y'),
       ('RPS_SHIPPING_SUMMARY_REPORT','USE_HEADER_SECTION','Y'),
       ('RPS_SHIPPING_SUMMARY_REPORT','HEADER_SECTION_TXT','ARC-One Solutions'),
       ('RPS_SHIPPING_SUMMARY_REPORT','USE_TRANSPORTATION_NUMBER','Y'),
       ('RPS_SHIPPING_SUMMARY_REPORT','DATE_TIME_FORMAT','MM/dd/yyyy HH:mm'),
       ...
       ('RPS_SHIPPING_SUMMARY_REPORT','BLOOD_CENTER_NAME','ARC-One Solutions');
