...
create or replace view recoveredplasmashipping.VW_RECOVERED_PLASMA_SHIPMENT_REPORT as
    select brps.id, brps.shipment_number ,brps.status , brps.shipment_date , brps.schedule_date , brps.customer_code , brps.customer_name
         , brps.location_code , ll."name" as location , brps.product_type , lrppt.product_type_description
