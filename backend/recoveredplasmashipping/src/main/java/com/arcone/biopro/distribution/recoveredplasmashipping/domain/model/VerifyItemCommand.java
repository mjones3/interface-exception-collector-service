...
@ToString
@Slf4j
public class VerifyItemCommand implements Validatable {
    ...
    public VerifyItemCommand(Long cartonId, String unitNumber, String productCode, String employeeId , String locationCode) {
