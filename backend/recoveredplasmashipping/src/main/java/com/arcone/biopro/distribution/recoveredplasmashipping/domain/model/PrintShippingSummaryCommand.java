...
@ToString
@Slf4j
public class PrintShippingSummaryCommand implements Validatable {

    private Long shipmentId;
    private String employeeId;
    private String locationCode;

    public PrintShippingSummaryCommand(Long shipmentId, String employeeId, String locationCode) {
