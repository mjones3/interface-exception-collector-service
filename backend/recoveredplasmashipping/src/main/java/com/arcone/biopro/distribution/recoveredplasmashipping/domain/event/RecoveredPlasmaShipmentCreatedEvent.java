...
@ToString
public class RecoveredPlasmaShipmentCreatedEvent implements DomainEvent<RecoveredPlasmaShipment> {
    ...
    public RecoveredPlasmaShipmentCreatedEvent (RecoveredPlasmaShipment recoveredPlasmaShipment){
