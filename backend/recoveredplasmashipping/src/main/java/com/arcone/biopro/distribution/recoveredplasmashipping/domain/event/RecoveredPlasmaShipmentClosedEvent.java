...
@ToString
public class RecoveredPlasmaShipmentClosedEvent implements DomainEvent<RecoveredPlasmaShipment> {
    ...
    public RecoveredPlasmaShipmentClosedEvent(RecoveredPlasmaShipment recoveredPlasmaShipment){
