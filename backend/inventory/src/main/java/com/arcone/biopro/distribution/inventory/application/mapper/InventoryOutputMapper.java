...
public abstract class InventoryOutputMapper {
    ...
    @Mapping(target = "modificationDate", source = "productModifiedInput.modificationDate")
    ...
    @Mapping(target = "collectionDate", source = "parent.collectionDate")
    @Mapping(target = "location", source = "parent.location")
    @Mapping(target = "aboRh", source = "parent.aboRh")
