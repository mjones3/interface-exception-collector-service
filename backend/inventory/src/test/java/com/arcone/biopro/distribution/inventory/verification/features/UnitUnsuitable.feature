...
Feature: Unit Unsuitable Event - API
    ...
    Scenario Outline: Update the status of multiple inventories with different product code but same division code after receiving a Unit Unsuitable event.
        ...
        Examples:
            ...
            | W036825043001 | E4689V00           | E4693V00            | AVAILABLE    | AVAILABLE     | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | RBC                | E070100             | AVAILABLE    | AVAILABLE     | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | E1624VA0           | E1624VB0            | AVAILABLE    | SHIPPED       | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | E1624VA0           | E1624VB0            | IN_TRANSIT   | DISCARDED     | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | E1624VA0           | RBC                 | CONVERTED    | CONVERTED     | Empty                          |
