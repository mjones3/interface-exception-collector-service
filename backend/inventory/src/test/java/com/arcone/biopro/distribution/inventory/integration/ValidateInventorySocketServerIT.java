...
public class ValidateInventorySocketServerIT {
    ...
    @Test
    @DisplayName("Should validate inventory successfully with no notifications")
    ...
    @Test
    @DisplayName("Should validate inventory and return expired notification")
    ...
    @Test
    @DisplayName("Should validate inventory and return quarantined notification")
    ...
    @Test
    @DisplayName("Should validate inventory and return not found notification")
    ...
    @Test
    @DisplayName("Should validate inventory and return not found in location notification")
    ...
    /**
     * Test method for validateInventoryBatch that creates 10,000 inventory items.
     *
     * This test verifies that the validateInventoryBatch method can handle a large batch
     * of inventory validation requests (10,000 items) and correctly process them.
     *
     ...
     */
    @Test
    @DisplayName("Should validate 10,000 inventory items in batch")
