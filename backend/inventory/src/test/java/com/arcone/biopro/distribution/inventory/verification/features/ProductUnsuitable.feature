...
Feature: Product Unsuitable Event - API
    ...
    Scenario Outline: Flag an inventory as unsuitable after receiving a Product Unsuitable event.
        ...
        Examples:
            | Unit Number   | Product Code | Status     | Unsuitable reason              |
            | W036825043001 | E4689V00     | AVAILABLE  | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | E4689V00     | IN_TRANSIT | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | E4689V00     | DISCARDED  | POSITIVE_REACTIVE_TEST_RESULTS |
            | W036825043001 | E4689V00     | SHIPPED    | POSITIVE_REACTIVE_TEST_RESULTS |
    ...
    Scenario Outline: Do not flag an inventory as unsuitable after receiving a Product Unsuitable event.
        ...
        Examples:
            | Unit Number   | Product Code | Status    | Unsuitable reason |
            | W036825043001 | E4689V00     | CONVERTED | Empty             |
