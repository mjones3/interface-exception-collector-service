...
Feature: Get all available inventories
    ...
    Scenario: Get all available inventories grouped
        Given I have the following units of products in inventory
            | Unit Number   | Units | Family                       | ABORh | Location   | Expires In |
            | W777725003016 | 2     | PLASMA_TRANSFUSABLE          | OP    | LOCATION_1 | 2 Days          |
            | W777725003017 | 3     | PLASMA_TRANSFUSABLE          | OP    | LOCATION_2 | 2 Days          |
            | W777725003018 | 5     | RED_BLOOD_CELLS              | OP    | LOCATION_1 | 2 Days          |
            | W777725003019 | 5     | RED_BLOOD_CELLS_LEUKOREDUCED | OP    | LOCATION_1 | 2 Days          |
            | W777725003020 | 8     | PLASMA_TRANSFUSABLE          | ON    | LOCATION_1 | 2 Days          |
            | W777725003021 | 13    | PLASMA_TRANSFUSABLE          | ABN   | LOCATION_1 | 2 Days          |
            | W777725003022 | 21    | PLASMA_TRANSFUSABLE          | ABP   | LOCATION_1 | 31 Days         |
            | W777725003023 | 4     | WHOLE_BLOOD                  | OP    | LOCATION_1 | 3 Days          |
            | W777725003024 | 5     | WHOLE_BLOOD_LEUKOREDUCED     | OP    | LOCATION_1 | 3 Days          |
            | W777725003025 | 10    | WHOLE_BLOOD                  | ABN   | LOCATION_1 | 6 Days          |
            | W777725003026 | 12    | WHOLE_BLOOD_LEUKOREDUCED     | ABN   | LOCATION_1 | 6 Days          |
            | W777725003027 | 3     | WHOLE_BLOOD                  | ABN   | LOCATION_1 | -1 Days         |
    ...
    Scenario: Get all available inventories not considering the other statuses
        Given I have the following inventories:
            ...
            | W777725003028 | E1624V00     | AVAILABLE  |                                | EMPTY              |
            | W777725003029 | E1624V00     | AVAILABLE  |                                |                    |
            | W777725003030 | E1624V00     | CONVERTED  |                                | EMPTY              |
            | W777725003031 | E1624V00     | DISCARDED  |                                |                    |
            | W777725003032 | E1624V00     | SHIPPED    |                                |                    |
            | W777725003033 | E1624V00     | IN_TRANSIT |                                | EMPTY              |
            | W777725003034 | E1624V00     | PACKED     |                                | EMPTY              |
            | W777725003035 | E1624V00     | AVAILABLE  | POSITIVE_REACTIVE_TEST_RESULTS |                    |
            | W777725003036 | E1624V00     | AVAILABLE  |                                | ABS_POSITIVE       |
