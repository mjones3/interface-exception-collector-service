...
Feature: Quarantine update it to product ProductQuarantine Event - API
    ...
    Scenario Outline: Update Quarantine to product with different reasons.
        ...
        When I received an Apply Quarantine event for unit "<Unit Number>" and product "E1624V00" with reason "Under investigation", id "<Id 1>" and stopManufacturing mark as "<Stop manufacturing true>"
        Then The inventory status has quarantine

        When I received an Apply Quarantine event for unit "<Unit Number>" and product "E1624V00" with reason "BCA Unit Needed", id "<Id 2>" and stopManufacturing mark as "<Stop manufacturing false>"
        Then The inventory status has quarantine

        When I received a Update Quarantine event for unit "<Unit Number>" and product "E1624V00" with reason "BCA Unit Needed", id "<Id 1>" and stopManufacturing "<Stop manufacturing false>"
