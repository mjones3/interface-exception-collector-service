...
Feature: Validate Inventory
    ...
    Scenario Outline: Validate Inventory
        ...
        Examples:
            ...
            | W012345678903 | E0869V02     | LOCATION_2 | INVENTORY_IS_QUARANTINED        |
            | W012345678904 | E0869V03     | LOCATION_1 | INVENTORY_IS_EXPIRED            |
            | W012345678901 | E0869V00     | LOCATION_2 | INVENTORY_NOT_FOUND_IN_LOCATION |
            | W012345678905 | E0869V05     | LOCATION_1 | INVENTORY_IS_DISCARDED          |
            | W012345678906 | E0869V05     | LOCATION_1 | INVENTORY_IS_UNSUITABLE         |
