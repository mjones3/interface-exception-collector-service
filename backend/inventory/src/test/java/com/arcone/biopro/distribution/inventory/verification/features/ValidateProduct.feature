...
Feature: Validate Inventory
    ...
    Scenario Outline: Validate Inventory
        ...
        Examples:
            ...
            | W012345678906 | E0869VD0     | LOCATION_1 | INVENTORY_IS_UNSUITABLE         | TRIGGER_DISCARD    |                 | This product has an active deferral with a discard consequence and has been discarded. Place in biohazard container. |                                                                                     |
            | W012345678906 | E1624V00     | LOCATION_1 | INVENTORY_IS_UNSUITABLE         | TRIGGER_DISCARD    |                 | This product has been discarded for Timing Rules. Place in biohazard container.                                      |                                                                                     |
