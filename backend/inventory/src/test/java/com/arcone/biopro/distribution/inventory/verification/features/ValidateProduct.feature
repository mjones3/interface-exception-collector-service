...
Feature: Validate Inventory
    ...
    Scenario Outline: Validate Inventory
        ...
        And I have one product with "W012345678908", "E0869V05" and "LOCATION_1" in "AVAILABLE" status and is unlabeled
        ...
        Examples:
            ...
            | W012345678908 | E0869V05     | LOCATION_1 | INVENTORY_IS_UNLABELED          | BACK_TO_STORAGE    |                 | This product is not labeled and cannot be shipped.                                                                                        |                                                                                     |
