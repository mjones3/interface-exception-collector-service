    ...
    Rule: As an inventory service I want to create an inventory update event every time an inventory is created/updated
        Scenario Outline: Produce an inventory updated event every time an inventory is create/update
            ...
            Examples:
                ...
                | Product Stored                  | W036825004006 | E1624V00     | E1624V00           |             |               |                   |           | reezer001      | Bin001,Shelf002,Tray001 | location_1 | STORED             |
                | Recovered Plasma Carton Packed  | W036825004007 | E1624V00     | E1624V00           |             |               |                   |           | reezer001      | Bin001,Shelf002,Tray001 | location_1 | PACKED             |
                | Recovered Plasma Carton Removed | W036825004008 | E1624V00     | E1624V00           |             |               |                   |           | reezer001      | Bin001,Shelf002,Tray001 | location_1 | UNPACKED           |
