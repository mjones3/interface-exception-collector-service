...
- validateInventory
  run the command: java -jar rsc-0.9.1.jar --debug --request --data "{\"unitNumber\":\"W012345678901\", \"productCode\":\"E0869V00\", \"locationCode\":\"LOCATION_1\"}" --route validateInventory tcp://api.local.gd:7002
