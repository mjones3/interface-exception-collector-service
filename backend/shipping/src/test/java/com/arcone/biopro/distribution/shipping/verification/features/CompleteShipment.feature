    ...
    Rule: I should be able to view the pending log of products to be filled for each line item on the Shipment Fulfillment Details page.
        ...
        Scenario Outline: Fill product with check digit <Check Digit Config>
            ...
            Examples:
                ...
                | 113          | 1           | Testing Customer | 10,5,8   | ABP,BP,OP | RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED |                         | not see any error    | RED BLOOD CELLS LEUKOREDUCED | ABP  | =<E0685V00 | =W81253010608500 | enabled            |       | enabled    |
