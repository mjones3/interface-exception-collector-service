...
Feature: Remove Product from a Shipment
    ...
    Background:
        Given I cleaned up from the database the packed item that used the unit number "W036898786801,W822530103001,W822530103002,W822530103003,W822530103004,W822530103005".
    ...
    Rule: I should be able to remove one, multiple, or all products from the order until the product status has been moved to shipped status.
        ...
        #refactor table
            Examples:
                | Order Number | Customer ID | Customer Name    | Quantity | BloodType | ProductFamily       | Family              | Type | UN               | Code       |
                | 108          | 1           | Testing Customer | 1        | ANY       | PLASMA_TRANSFUSABLE | PLASMA TRANSFUSABLE | ANY  | =W03689878680200 | =<E7648V00 |
