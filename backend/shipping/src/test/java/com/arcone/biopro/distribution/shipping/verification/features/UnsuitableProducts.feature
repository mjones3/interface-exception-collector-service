...
Feature: Prevent filling a shipment with unsuitable products
    ...
    Background:
        Given I cleaned up from the database, all shipments with order number "999771,999778,999764,999779,999765,999766,999767,999768,999769,999770,999771,999772,999773,999774,999775,999776,4440009".
    ...
    Scenario Outline: Filling a product which is already filled in another shipment
        ...
        Scenario Outline: Fill shipments with ineligible Products.
            ...
            Examples:
                ...
                | 999766       | 1           | Testing Customer  | 10       | ANY       | PLASMA_TRANSFUSABLE              |  FROZEN              | CUSTOMER          | LABELED      | false                 | W036898786756 | E0701V00 | SATISFACTORY   | This product is expired and has been discarded. Place in biohazard container.                             | INFO         |
                | 999767       | 1           | Testing Customer  | 5        | ANY       | RED_BLOOD_CELLS_LEUKOREDUCED     |  FROZEN              | CUSTOMER          | LABELED      | false                 | W036898786758 | E0703V00 | SATISFACTORY   | This product is quarantined and cannot be shipped                                                         | INFO         |
                ...
                | 45200007     | DO1         | Distribution Only | 10       | ANY       | PLASMA_TRANSFUSABLE              |  FROZEN              | INTERNAL_TRANSFER  | UNLABELED   | false                 | W036898786756 | GENERIC_CODE | SATISFACTORY   | This product is expired and has been discarded. Place in biohazard container.                             | INFO         |
                | 45200008     | DO1         | Distribution Only | 5        | ANY       | RED_BLOOD_CELLS_LEUKOREDUCED     |  FROZEN              | INTERNAL_TRANSFER  | UNLABELED   | false                 | W036898786758 | GENERIC_CODE | SATISFACTORY   | This product is quarantined and cannot be shipped                                                         | INFO         |
                | 45200009     | DO1         | Distribution Only | 5        | ABP       | WHOLE_BLOOD_LEUKOREDUCED         |  FROZEN              | INTERNAL_TRANSFER  | UNLABELED   | false                 | W812530107002 | GENERIC_CODE | SATISFACTORY   | Product Family does not match                                                                             | WARN         |
                | 452000010    | DO1         | Distribution Only | 5        | BP        | WHOLE_BLOOD                      |  FROZEN              | INTERNAL_TRANSFER  | UNLABELED   | false                 | W812530107002 | GENERIC_CODE | SATISFACTORY   | Blood type does not match                                                                                 | WARN         |
                | 452000011    | DO1         | Distribution Only | 5        | ON        | RED_BLOOD_CELLS                  |  FROZEN              | INTERNAL_TRANSFER  | UNLABELED   | false                 | W812530107003 | GENERIC_CODE | UNSATISFACTORY | This product has been discarded for failed visual inspection in the system. Place in biohazard container. | WARN         |
                | 452000012    | DO1         | Distribution Only | 5        | ON        | PLASMA_TRANSFUSABLE              |  FROZEN              | INTERNAL_TRANSFER  | UNLABELED   | false                 | W812530107004 | GENERIC_CODE | SATISFACTORY   | Temperature Category does not match                                                                       | WARN         |
                | 452000013    | DO1         | Distribution Only | 5        | A         | APHERESIS_PLATELETS_LEUKOREDUCED |  ROOM_TEMPERATURE    | INTERNAL_TRANSFER  | UNLABELED   | true                  | W812530444002 | GENERIC_CODE | SATISFACTORY   | Shipment can only contain quarantined products                                                            | WARN         |
                | 452000014    | DO1         | Distribution Only | 5        | A         | APHERESIS_PLATELETS_LEUKOREDUCED |  ROOM_TEMPERATURE    | INTERNAL_TRANSFER  | LABELED     | false                 | W812530444002 | GENERIC_CODE | SATISFACTORY   | Product is not labeled                                                            | WARN         |
                | 452000015    | DO1         | Distribution Only | 5        | A         | APHERESIS_PLATELETS_LEUKOREDUCED |  ROOM_TEMPERATURE    | INTERNAL_TRANSFER  | UNLABELED   | false                 | W812530444002 | E0701V00     | SATISFACTORY   | Product is labeled                                                            | WARN         |
