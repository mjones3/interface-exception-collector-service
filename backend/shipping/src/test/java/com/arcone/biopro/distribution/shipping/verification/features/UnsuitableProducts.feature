Feature: Prevent filling a shipment with unsuitable products
    ...
    Scenario Outline: Entering an unsuitable product
        ...
        Examples:
            ...
            | W036898786756    | E0701V00   | Satisfactory | This product is expired and cannot be shipped.              | 999771      | 999991      | Tampa         | 10,5,23  | AP,AN,OP  | PLASMA_TRANSFUSABLE,PLASMA_TRANSFUSABLE,PLASMA_TRANSFUSABLE | PLASMA TRANSFUSABLE |
            | =W03689878676300 | =<E0703V00 | Satisfactory | This product is not in the inventory and cannot be shipped. | 999778      | 999998      | Tampa         | 10,5,23  | AP,AN,OP  | PLASMA_TRANSFUSABLE,PLASMA_TRANSFUSABLE,PLASMA_TRANSFUSABLE | PLASMA TRANSFUSABLE |
