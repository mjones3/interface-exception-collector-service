...
Feature: Prevent filling a shipment with unsuitable products
    ...
    Scenario Outline: Entering an unsuitable product
        ...
        Examples:
            ...
            | =W03689878675800 | =<GENERIC_CODE | Satisfactory | This unit does not match the order product criteria                           | Acknowledgment Message | 999778      | 999998      | Tampa         | 10,5,23  | AP,AN,OP  | RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED | RED BLOOD CELLS LEUKOREDUCED |
            | =W03689878676300 | =<E0703V00     | Satisfactory | This unit does not match the order product criteria                           | Warning                | 999779      | 999998      | Tampa         | 10,5,23  | AP,AN,OP  | PLASMA_TRANSFUSABLE,PLASMA_TRANSFUSABLE,PLASMA_TRANSFUSABLE                            | PLASMA TRANSFUSABLE          |
