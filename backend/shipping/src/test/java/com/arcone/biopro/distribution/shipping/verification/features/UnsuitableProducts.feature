    ...
    Scenario Outline: Filling a product which is already filled in another shipment
        ...
        Scenario Outline: Fill shipments with ineligible Products.
            ...
            Examples:
                ...
                | 45200008     | DO1         | Distribution Only | 5        | ANY       | RED_BLOOD_CELLS_LEUKOREDUCED     | FROZEN               | INTERNAL_TRANSFER | UNLABELED    | false                | W036825158907 | BAG-B      | SATISFACTORY   | This product is quarantined and cannot be shipped                                                         | INFO         |
