    ...
    Rule: I should not be able fill orders with ineligible Products.
        ...
        Scenario Outline: Fill shipments with ineligible Products.
            ...
            Examples:
                ...
                | 999775       | 1           | Testing Customer | 5        | BP        | PRT_APHERESIS_PLATELETS          |  FROZEN              |W812530107010 | E9431V00 | SATISFACTORY   | Temperature Category does not match                                                                       | WARN         |
                ...
                | 999775       | 1           | Testing Customer | 5        | BP        | PRT_APHERESIS_PLATELETS          | W812530107010 | EB317V00 | SATISFACTORY   | Temperature Category does not match                                                                       | WARN         |
