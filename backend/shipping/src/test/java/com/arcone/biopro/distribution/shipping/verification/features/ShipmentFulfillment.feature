   ...
   Scenario Outline: Restart verification status when a Product is added into a Shipment.
    ...
    Scenario Outline: Fill Shipment with Labeled Products.
        ...
        Examples:
            ...
            | 44400014     | DO1         | Distribution Only | 2        | ANY       | PLASMA_TRANSFUSABLE                                         | PLASMA TRANSFUSABLE              | ANY  | =W03689878675800 | =<E0701V00 | enabled           | FROZEN           | INTERNAL_TRANSFER | LABELED      | true                 | should          |
        ...
        Scenario Outline: Fill Shipment with Unlabeled Unit with multiple products.
            ...
            Then I should not see the product selection option with the products "<negative_product_list>".
            ...
            Examples:
                ...
                | 45200001     | DO1         | Distribution Only | 2        | ANY       | PLASMA_TRANSFUSABLE          | PLASMA TRANSFUSABLE          | ANY  | =W03689878675800 | CPD PLS MI 48H       | LR_RBC,CPD PLS MI 24H,CPD PLS MI 48H      |                       | enabled           | FROZEN   | INTERNAL_TRANSFER | UNLABELED    | true                 | should not      |
