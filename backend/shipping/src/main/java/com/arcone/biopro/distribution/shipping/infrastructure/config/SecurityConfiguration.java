...
import com.arcone.biopro.distribution.shipping.infrastructure.config.security.AuthoritiesConstants;
import com.arcone.biopro.distribution.shipping.infrastructure.config.security.SecurityUtils;
import com.arcone.biopro.distribution.shipping.infrastructure.config.security.oauth2.AudienceValidator;
import com.arcone.biopro.distribution.shipping.infrastructure.config.security.oauth2.JwtGrantedAuthorityConverter;
...
public class SecurityConfiguration {
    ...
    @Value("${spring.graphql.path:/shipping/graphql}")
