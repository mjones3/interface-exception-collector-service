...
VALUES
    ...
    (8,'ROOM_TEMPERATURE', false, 'TRANSIT_TIME', 'VALUE_FORMULA', 'TRANSIT_TIME > (23.99 * 60) || TRANSIT_TIME < 0', 'QUARANTINE', 'OUT_OF_TRANSIT_TIME', 8, true, now(), now()),
    ...
    (12,'REFRIGERATED', false, 'VISUAL_INSPECTION', 'VALUE_EQUALS', 'UNACCEPTABLE', 'QUARANTINE', 'FAILED_VISUAL_INSPECTION', 15, true, now(), now());
