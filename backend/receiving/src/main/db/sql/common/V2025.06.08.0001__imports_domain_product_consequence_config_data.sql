...
VALUES
    ...
    (7,'ROOM_TEMPERATURE', true, 'TRANSIT_TIME', 'VALUE_FORMULA', 'TRANSIT_TIME >= 0 && TRANSIT_TIME <= (24 * 60)', 'RETURN_TO_INVENTORY', 'return-to-inventory.label', 7, true, now(), now()),
    (8,'ROOM_TEMPERATURE', false, 'TRANSIT_TIME', 'VALUE_FORMULA', 'TRANSIT_TIME > (24 * 60) || TRANSIT_TIME < 0', 'ADD_INVENTORY_QUARANTINE', 'quarantine-reason.transit-time-exceeded', 8, true, now(), now()),
