    ...
    Rule: I should be notified when I enter an invalid expiration date.
        ...
        Scenario Outline: Validation of invalid product information - UI
            ...
            And I have the following valid product information:
                ...
                | Unit Number     | =W03659878680500 |
                | Blood Type      | =%6200           |
                | Expiration Date | &>0260422359     |
                | Product Code    | =<E8341V00       |
            And I scan the product information with field "<Field Name>" as "<Field Value>".
            Then I should see a "WARNING" message: "<message>".
            And I "should not" see product unit number "<Unit Number>" and product code "<Product Code>" in the list of added products.
            And The add product option should be "disabled".
            Examples:
                | Device Location Code | Device ID     | Device Type | Device Category | Field Name      | Field Value      | message                                  |
                | 123456789            | THERM-DST-412 | THERMOMETER | TEMPERATURE     | Unit Number     | =W036880500      | Invalid Unit Number                      |
                | 123456789            | THERM-DST-412 | THERMOMETER | TEMPERATURE     | ABO/RH          | =%0200           | Invalid ABO/RH                           |
                | 123456789            | THERM-DST-412 | THERMOMETER | TEMPERATURE     | Expiration Date | &>0200002359     | Invalid expiration date                  |
                | 123456789            | THERM-DST-412 | THERMOMETER | TEMPERATURE     | Product Code    | =<E617           | Invalid Product Code                     |
                | 123456789            | THERM-DST-412 | THERMOMETER | TEMPERATURE     | Unit Number     | =W03399878680500 | This FIN is not registered in the system |
                | 123456789            | THERM-DST-412 | THERMOMETER | TEMPERATURE     | Product Code    | =<E0023V00       | Product type does not match              |
        ...
        Scenario Outline: Validating label barcode product information
            ...
            Examples:
                ...
                | REFRIGERATED         | BARCODE_UNIT_NUMBER     | =W03259878680500 | false   | W032598786805        | W032598786805      | should           | This FIN is not registered in the system |
