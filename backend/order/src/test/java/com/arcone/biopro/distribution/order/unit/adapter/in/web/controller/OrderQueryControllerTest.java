...
import com.arcone.biopro.distribution.order.application.exception.QueryDomainNotFoundException;
...
class OrderQueryControllerTest {
    ...
    public void shouldNotSearchOrders(){
        ...
        Mockito.when(serviceMock.searchOrders(Mockito.any())).thenReturn(Flux.error(new QueryDomainNotFoundException()));
        ...
        StepVerifier.create(orderQueryController.searchOrders(command))
            .expectError(QueryDomainNotFoundException.class)
            .verify();
