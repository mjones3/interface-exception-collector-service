    ...
    Rule: I should be able to search completed orders by order number.
        ...
        Scenario Outline: Search orders by Ship to Customer/Location based on the shipment type
            ...
            Examples:
                ...
                | ORDERDIS481005 | 123456789_DIS481 | STAT     | OPEN   | RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED         | AP,OP     | 10,7     | INTERNAL_TRANSFER | FEDEX           | FROZEN           | 2024-08-20   | DO1                    | Distribution Only          | <null>                | <null>                     | Confirm when ready | Needed asap, Another comment | false                | LABELED      | locationCode, createDateFrom, createDateTo, shipmentType, customers | '123456789_DIS481', <yesterday>, <today>, 'INTERNAL_TRANSFER','D01' |
                | ORDERDIS481006 | 123456789_DIS481 | STAT     | OPEN   | WHOLE_BLOOD,WHOLE_BLOOD                                           | ANY,ANY   | 10,7     | INTERNAL_TRANSFER | FEDEX           | REFRIGERATED     | 2024-08-20   | DO1                    | Distribution Only          | <null>                | <null>                     | Confirm when ready | Needed asap, Another comment | true                 | UNLABELED    | locationCode, createDateFrom, createDateTo, shipmentType, customers | '123456789_DIS481', <yesterday>, <today>, 'INTERNAL_TRANSFER','D01' |
