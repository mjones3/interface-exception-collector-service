...
public class DatabaseQueries {
    ...
    public static String insertBioProOrderWithDetails(String externalId, String locationCode, Integer priority, String deliveryType, String status, String shipmentType, String shippingMethod, String productCategory, String desiredShipDate, String shippingCustomerCode, String shippingCustomerName, String billingCustomerCode, String billingCustomerName, String comments , String shipToLocationCode , boolean quarantinedProducts) {
        return String.format("INSERT INTO bld_order (external_id, location_code, priority, delivery_type, status, shipment_type, shipping_method, product_category, desired_shipping_date, shipping_customer_code, shipping_customer_name, billing_customer_code, billing_customer_name, comments, create_employee_id, create_date, modification_date , ship_to_location_code , quarantined_products) " +
            "VALUES ('%s', '%s', %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', 'ee1bf88e-2137-4a17-835a-d43e7b738374',current_date, current_date,'%s',%s)", externalId, locationCode, priority, deliveryType, status, shipmentType, shippingMethod, productCategory, desiredShipDate, shippingCustomerCode, shippingCustomerName, billingCustomerCode, billingCustomerName, comments ,shipToLocationCode , quarantinedProducts);
    }
