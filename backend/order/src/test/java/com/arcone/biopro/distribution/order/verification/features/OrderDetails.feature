...
Feature: View order details
    ...
    Background:
        ...
        Scenario Outline: View order details
            ...
            Examples:
                | External ID    | LocationCode | Priority | Status | ProductFamily                                                     | BloodType | Quantity | Shipment Type     | Shipping Method | Product Category | Desired Date | Shipping Customer Code | Shipping Customer Name     | Billing Customer Code | Billing Customer Name      | Order Comments     | Item Comments                | Quarantined Products | Label Status | Can/Cannot |
                | ORDER001       | 123456789    | STAT     | OPEN   | PLASMA_TRANSFUSABLE, PLASMA_TRANSFUSABLE                          | AB, O     | 3, 2     | CUSTOMER          | FEDEX           | FROZEN           | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDER006       | 123456789    | STAT     | OPEN   | RED_BLOOD_CELLS_LEUKOREDUCED, RED_BLOOD_CELLS_LEUKOREDUCED        | AP, ON    | 5, 5     | CUSTOMER          | FEDEX           | REFRIGERATED     | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDER008       | 123456789    | STAT     | OPEN   | WHOLE_BLOOD,WHOLE_BLOOD                                           | AP, AN    | 5, 5     | CUSTOMER          | FEDEX           | REFRIGERATED     | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDER009       | 123456789    | STAT     | OPEN   | WHOLE_BLOOD_LEUKOREDUCED, WHOLE_BLOOD_LEUKOREDUCED                | ABN, ABP  | 5, 3     | CUSTOMER          | FEDEX           | REFRIGERATED     | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDER010       | 123456789    | STAT     | OPEN   | RED_BLOOD_CELLS, RED_BLOOD_CELLS                                  | ON, OP    | 10, 5    | CUSTOMER          | FEDEX           | REFRIGERATED     | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDERDIS336001 | 123456789    | STAT     | OPEN   | APHERESIS_PLATELETS_LEUKOREDUCED,APHERESIS_PLATELETS_LEUKOREDUCED | AB,A      | 2,50     | CUSTOMER          | FEDEX           | ROOM_TEMPERATURE | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDERDIS336002 | 123456789    | STAT     | OPEN   | PRT_APHERESIS_PLATELETS,PRT_APHERESIS_PLATELETS                   | AB,A      | 10,5     | CUSTOMER          | FEDEX           | ROOM_TEMPERATURE | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDERDIS336003 | 123456789    | STAT     | OPEN   | PRT_APHERESIS_PLATELETS,PRT_APHERESIS_PLATELETS                   | AB,O      | 10,7     | CUSTOMER          | FEDEX           | REFRIGERATED     | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDERDIS337001 | 123456789    | STAT     | OPEN   | RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED         | AP,OP     | 10,7     | CUSTOMER          | FEDEX           | FROZEN           | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        |
                | ORDERDIS400001 | 123456789    | STAT     | OPEN   | RED_BLOOD_CELLS_LEUKOREDUCED,RED_BLOOD_CELLS_LEUKOREDUCED         | AP,OP     | 10,7     | INTERNAL_TRANSFER | FEDEX           | FROZEN           | 2024-08-20   | DO1                    | Distribution Only          | <null>                | <null>                     | Confirm when ready | Needed asap, Another comment | false                | LABELED      | can not    |
                | ORDERDIS400002 | 123456789    | STAT     | OPEN   | WHOLE_BLOOD,WHOLE_BLOOD                                           | ANY,ANY   | 10,7     | INTERNAL_TRANSFER | FEDEX           | FROZEN           | 2024-08-20   | DO1                    | Distribution Only          | <null>                | <null>                     | Confirm when ready | Needed asap, Another comment | true                 | UNLABELED    | can not    |
