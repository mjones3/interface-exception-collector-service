    ...
    Background:
        ...
        Scenario Outline: View order details
            ...
            Examples:
                ...
                | ORDERDIS336001 | 123456789    | STAT     | OPEN   | APHERESIS_PLATELETS_LEUKOREDUCED                           | AB        | 10       | CUSTOMER      | FEDEX           | ROOM_TEMPERATURE | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment |
