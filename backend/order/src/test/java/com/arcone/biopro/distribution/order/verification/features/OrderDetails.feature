...
Feature: View order details
    ...
    Background:
        ...
        @DIS155 @DIS-121 @DIS-100 @DIS-97 @DIS-161 @DIS-253 @bug @DIS-295 @bug @DIS-321 @DIS-336 @DIS-337 @DIS-400 @DIS-440 @DIS-446 @DIS-479
        Scenario Outline: View order details
            ...
            Examples:
                ...
                | ORDERDIS479001 | 123456789    | STAT     | OPEN   | WASHED_APHERESIS_PLATELETS, WASHED_APHERESIS_PLATELETS            | AB,A      | 2, 50    | CUSTOMER          | FEDEX           | ROOM_TEMPERATURE | 2024-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        | cannot      |
    ...
    Rule: The shipment details for washed apheresis platelets products, for washed PRT apheresis platelets products, and for washed red blood cells products should be generated.
            ...
            Examples:
                ...
                | ORDERDIS447002 | 123456789    | STAT     | OPEN   | PLASMA_MFG_NONINJECTABLE     | B         | 8        | CUSTOMER          | FEDEX           | REFRIGERATED     | 2025-09-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Send asap          | Needed asap   | CANNOT     | LABELED      | false                |
                | ORDERDIS447003 | 123456789    | STAT     | OPEN   | PLASMA_MFG_INJECTABLE        | ANY       | 8        | CUSTOMER          | FEDEX           | FROZEN           | 2025-09-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Send asap          | Needed asap   | CANNOT     | LABELED      | false                |
                | ORDERDIS479011 | 123456789    | STAT     | OPEN   | WASHED_APHERESIS_PLATELETS     | ANY       | 10       | CUSTOMER          | FEDEX           | ROOM_TEMPERATURE | 2025-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap   | CANNOT     | LABELED      | false                |
                | ORDERDIS479012 | 123456789    | STAT     | OPEN   | WASHED_PRT_APHERESIS_PLATELETS | ANY       | 10       | CUSTOMER          | FEDEX           | ROOM_TEMPERATURE | 2025-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap   | CANNOT     | <null>       | false                |
                | ORDERDIS479013 | 123456789    | STAT     | OPEN   | WASHED_RED_BLOOD_CELLS         | ANY       | 10       | CUSTOMER          | FEDEX           | REFRIGERATED     | 2025-08-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Confirm when ready | Needed asap   | CANNOT     | LABELED      | false                |
