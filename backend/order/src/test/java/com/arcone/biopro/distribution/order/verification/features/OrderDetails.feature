...
Feature: View order details
    ...
    Background:
        ...
        Scenario Outline: View order details
            ...
            Examples:
                ...
                | ORDERDIS446002 | 123456789    | STAT     | OPEN   | PLASMA_MFG_INJECTABLE, PLASMA_MFG_INJECTABLE                      | A,O       | 10,7     | CUSTOMER          | FEDEX           | FROZEN           | 2025-08-20   | DO1                    | Distribution Only          | <null>                | <null>                     | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        | cannot      |
                | ORDERDIS446003 | 123456789    | STAT     | OPEN   | CRYOPRECIPITATE, CRYOPRECIPITATE                                  | ANY,ANY   | 10,7     | CUSTOMER          | FEDEX           | FROZEN           | 2025-08-20   | DO1                    | Distribution Only          | <null>                | <null>                     | Confirm when ready | Needed asap, Another comment | <null>               | <null>       | can        | cannot        |
    ...
    Rule: I should be able to create the order fulfillment request when the pick list is generated.Rule: The BioPro order status must be updated to InProgress when an order is being fulfilled.
            ...
            Examples:
                ...
                | ORDERDIS446    | 123456789    | STAT     | OPEN   | CRYOPRECIPITATE              | A         | 8        | CUSTOMER          | FEDEX           | FROZEN           | 2025-09-20   | A1235                  | Creative Testing Solutions | A1235                 | Creative Testing Solutions | Send asap          | Needed asap   | CANNOT     | LABELED      | false                |
