...
class PickListCreatedListenerTest {
    ...
    public void shouldHandlePickListCreatedEvents(){
        ...
        Mockito.when(pickList.getShipmentType()).thenReturn("CUSTOMER");
        ...
        var locationRepository = Mockito.mock(LocationEntityRepository.class);
        ...
        Mockito.when(orderFulfilledMapper.buildShippingCustomerDetails(Mockito.any(),Mockito.any())).thenReturn(Mono.just(Mockito.mock(OrderFulfilledEventDTO.class)));
        ...
        PickListCreatedListener target = new PickListCreatedListener(producerTemplate, "TestTopic", orderRepository, customerService, orderFulfilledMapper,locationRepository);
    ...
    @Test
    public void shouldHandlePickListCreatedEventsWhenInternalTransfer(){
        ...
        Mockito.when(locationRepository.findByCode(Mockito.any())).thenReturn(Mono.just(LocationEntity
            .builder()
            .build()));
        ...
        Mockito.when(orderFulfilledMapper.buildShippingCustomerDetailsFromLocation(Mockito.any(),Mockito.any())).thenReturn(Mono.just(Mockito.mock(OrderFulfilledEventDTO.class)));
