    ...
    Rule: The cancelled order request must be rejected if the external order ID does not exist.
        ...
        Scenario Outline: Cancel an Open Biopro order from a valid Cancel Order request.
            ...
            Examples:
                ...
                | EXTDIS3150001      | EXTDIS3150001      | false          | OPEN           | CANCELLED    | should                                   |
                | EXTDIS3150002      | EXTDIS3150002      | true           | OPEN           | CANCELLED    | should                                   |
                ...
                | EXTDIS3150005      | EXTDIS3150005      | false          | CANCELLED      | CANCELLED    | should not                               |
