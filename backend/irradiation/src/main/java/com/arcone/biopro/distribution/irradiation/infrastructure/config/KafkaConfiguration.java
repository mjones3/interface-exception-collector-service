...
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.checkin.CheckInCompleted;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.completed.apheresis.ApheresisPlasmaProductCompleted;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.completed.apheresis.ApheresisPlateletProductCompleted;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.completed.apheresis.ApheresisRBCProductCompleted;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.created.apheresis.ApheresisPlasmaProductCreated;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.created.apheresis.ApheresisPlateletProductCreated;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.created.apheresis.ApheresisRBCProductCreated;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.created.wholeblood.WholeBloodProductCreated;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.discarded.ProductDiscarded;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.imported.ProductsImported;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.label.LabelApplied;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.labelinvalidated.LabelInvalidated;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.modified.ProductModified;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.quarantine.ProductQuarantined;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.quarantine.QuarantineRemoved;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.quarantine.QuarantineUpdated;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.recovered.*;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.shipment.ShipmentCompleted;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.storage.ProductStored;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.unsuitable.ProductUnsuitable;
import com.arcone.biopro.distribution.irradiation.adapter.in.listener.unsuitable.UnitUnsuitable;
...
class KafkaConfiguration {
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Product Unsuitable event to change irradiation status to UNSUITABLE",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Label Applied has been listened and an irradiation was created",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Shipment Completed has been listened and an irradiation status was updated to SHIPPED",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Product Discarded has been listened and an irradiation status was updated to discarded",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Product Recovered has been listened and an irradiation status was restored",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Recovered Plasma Shipment Closed event has been listened and irradiation status was updated",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Recovered Plasma Carton Packed event has been listened and irradiation status was updated",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Recovered Plasma Carton Removed event has been listened and irradiation status was updated",
    ...
    @AsyncListener(operation = @AsyncOperation(
        ...
        description = "Recovered Plasma Carton Unpacked event has been listened and irradiation status was updated",
    ...
    @AsyncPublisher(operation = @AsyncOperation(
        ...
        description = "An irradiation was created/updated.",
