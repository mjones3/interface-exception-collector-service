...
class ProductCreatedUseCaseTest {
    ...
    @Test
    @DisplayName("should create irradiation and publish event successfully")
    void test1() {
    ...
    @Test
    @DisplayName("should create new irradiation when not found")
    void test2() {
        when(configurationService.lookUpTemperatureCategory(any())).thenReturn(Mono.empty());
        var input = ProductCreatedInput.builder()
            .unitNumber("W123456789012")
    ...
    @Test
    @DisplayName("should throw InvalidUpdateProductStatusException when irradiation is not available")
    void test3() {
        var input = ProductCreatedInput.builder()
            .unitNumber("W123456789012")
            .productCode("E123412")
    ...
    @Test
    @DisplayName("should throw InvalidUpdateProductStatusException when irradiation is available but is labeled")
    void test4() {
        var input = ProductCreatedInput.builder()
            .unitNumber("W123456789012")
            .productCode("E123412")
    ...
    @Test
    @DisplayName("should throw InvalidUpdateProductStatusException when irradiation is available, is not labeled but is quarantined")
    void test5() {
        var input = ProductCreatedInput.builder()
            .unitNumber("W123456789012")
            .productCode("E123412")
