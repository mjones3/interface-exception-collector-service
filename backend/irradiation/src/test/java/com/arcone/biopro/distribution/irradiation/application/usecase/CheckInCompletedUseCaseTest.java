...
class CheckInCompletedUseCaseTest {
    ...
    @Test
    @DisplayName("should create new irradiation successfully when irradiation does not exist")
    void test1() {
    ...
    @Test
    @DisplayName("should throw InventoryAlreadyExistsException when irradiation exists")
    void test2() {
        var input = CheckInCompletedInput.builder()
            .unitNumber("W123456789012")
            .productCode("E123412")
