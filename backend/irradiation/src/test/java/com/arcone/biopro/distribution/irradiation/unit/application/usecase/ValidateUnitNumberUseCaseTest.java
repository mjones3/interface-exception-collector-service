...
class ValidateUnitNumberUseCaseTest {
    ...
    void execute_ShouldReturnEmptyFlux_WhenNoInventoryFound() {
    ...
    @Test
    @DisplayName("Should return empty flux when inventory not at target location")
    void execute_ShouldReturnEmptyFlux_WhenInventoryNotAtTargetLocation() {
        String unitNumber = "W777725001001";
        String location = "123456789";
        when(inventoryClient.getInventoryByUnitNumber(any(UnitNumber.class)))
