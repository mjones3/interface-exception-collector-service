...
public record OrderCancelledPayload(
    ...
    @Schema(name = "cancelEmployeeId", title = "Cancel employee ID", description = "The employee ID who cancelled the order", requiredMode = REQUIRED)
    String cancelEmployeeId,
    @Schema(name = "cancelDate", title = "Cancel date", description = "The order cancellation date", requiredMode = REQUIRED)
    Instant cancelDate,
    @Schema(name = "cancelReason", title = "Cancel reason", description = "The reason for cancellation", requiredMode = REQUIRED)
    String cancelReason,
