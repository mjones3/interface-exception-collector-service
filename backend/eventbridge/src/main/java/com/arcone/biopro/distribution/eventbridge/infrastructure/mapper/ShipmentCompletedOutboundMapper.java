...
public class ShipmentCompletedOutboundMapper {
    ...
    public ShipmentCompletedOutboundPayload toDto(ShipmentCompletedOutbound shipmentCompletedOutbound){
        return ShipmentCompletedOutboundPayload
            ...
            .deliveryType(shipmentCompletedOutbound.getDeliveryType())
            .departmentCode(shipmentCompletedOutbound.getShipmentCustomer().departmentCode())
            .customerName(shipmentCompletedOutbound.getShipmentCustomer().customerName())
