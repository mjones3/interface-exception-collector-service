...
@Builder
public record OrderModifiedPayload(
    ...
    @Schema(name = "modifyEmployeeId", title = "Modify employee ID", description = "The employee ID who modified the order", requiredMode = REQUIRED)
    String modifyEmployeeId,
    @Schema(name = "modifyDate", title = "Modify date", description = "The order modification date", requiredMode = REQUIRED)
    Instant modifyDate,
    @Schema(name = "modifyReason", title = "Modify reason", description = "The reason for modification", requiredMode = REQUIRED)
    String modifyReason,
    ...
    public record OrderItem(
        @Schema(name = "productFamily", title = "Product family", description = "The product family", example = "PLASMA_TRANSFUSABLE", requiredMode = REQUIRED)
        String productFamily,
        @Schema(name = "bloodType", title = "Blood type", description = "The blood type", example = "A", requiredMode = REQUIRED)
        String bloodType,
        @Schema(name = "quantity", title = "Quantity", description = "The quantity", example = "10", requiredMode = REQUIRED)
        Integer quantity,
        @Schema(name = "quantityShipped", title = "Quantity shipped", description = "The quantity shipped", example = "0", requiredMode = REQUIRED)
        Integer quantityShipped,
        @Schema(name = "quantityRemaining", title = "Quantity remaining", description = "The quantity remaining", example = "10", requiredMode = REQUIRED)
