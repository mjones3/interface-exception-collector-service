...
public record OrderCreatedEventDTO(
    @Schema(name = "eventId", title = "Event Id", description = "The event id", example = "bb61626e-99df-48af-9ccf-107a5f2f06d0", requiredMode = REQUIRED)
    UUID eventId,
    @Schema(name = "occurredOn", title = "Occurred On", description = "The event occurred on", example = "2025-06-18T18:25:58.951619900Z", requiredMode = REQUIRED)
    Instant occurredOn,
