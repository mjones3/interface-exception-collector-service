package com.arcone.biopro.distribution.eventbridge.verification;
...
@SelectDirectories("src/test/java/com/arcone/biopro/distribution/eventbridge/verification/features")
@ConfigurationParameters({
    @ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "json:target/cucumber/cucumber.json"),
    @ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.arcone.biopro.distribution.eventbridge.verification.steps"),
